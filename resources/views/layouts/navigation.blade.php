                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="right" width="48">
                            ...
                            @if ($campaign->has('homepages'))
                            <x-slot name="content">
                                @foreach($campaign->homepages as $homepage)
                                    <x-dropdown-link :href="route('homepage.edit', $homepage)">
                                        {{ $homepage->id }}
                                    </x-dropdown-link>
                                @endforeach
                            </x-slot>
                    ...
                    <x-nav-link :href="route('salesperson.index')" :active="request()->routeIs('salesperson.index')">
                        {{ __('Sales People') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('submissions.export')">
